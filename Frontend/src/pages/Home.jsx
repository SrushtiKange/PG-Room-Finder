...
//       {/* Main Hero Section */}
//       <div className="bg-gradient-to-r from-blue-100 via-white to-blue-100 py-20 px-6 text-center">
//         <h1 className="text-4xl md:text-6xl font-bold text-blue-800 mb-6">
//           Find Your Perfect PG with RoomFinder
//         </h1>
...
//         <h2 className="text-3xl font-bold text-center text-blue-700 mb-12">About Us</h2>
//         <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
//           {/* Card 1 */}
//           <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
//             <h3 className="text-xl font-semibold mb-3 text-blue-600">Easy PG Search</h3>
//             <p className="text-gray-700">
//               Search PGs based on location, rent, room type, and gender filters. Fast and user-friendly experience.
//             </p>
//           </div>

//           {/* Card 2 */}
//           <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
//             <h3 className="text-xl font-semibold mb-3 text-blue-600">Verified Listings</h3>
//             <p className="text-gray-700">
//               All listings are verified to ensure you get genuine and secure accommodation without worry.
//             </p>
//           </div>

//           {/* Card 3 */}
//           <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-300">
//             <h3 className="text-xl font-semibold mb-3 text-blue-600">Connect Easily</h3>
//             <p className="text-gray-700">
//               Directly connect with PG owners or roommates via chat, calls, or booking requests.
//             </p>
//           </div>
//         </div>
//       </div>
